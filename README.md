...
<head>
<title>Live View Page -  563 seo dream Template</title>
<meta name="description" content="Live view page for  563 seo dream Template, download free CSS templates for your website" />
...
<script async src="https://securepubads.g.doubleclick.net/tag/js/gpt.js"></script>
  ...
  window.googletag = window.googletag || {cmd: []};
        googletag.cmd.push(function() {
          var interstitialSlot = googletag.defineOutOfPageSlot('/147246189,22381294811/templatemo.com_interstitial', googletag.enums.OutOfPageFormat.INTERSTITIAL);
...
<body>
    <div id="live-view">
        <iframe style="display: block; position: absolute; width: 100%; height: 100%;" width="100%" height="100%" frameborder="0" src="https://templatemo.com/templates/templatemo_563_seo_dream"></iframe>
    </div>
